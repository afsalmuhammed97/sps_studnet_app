 ...
 * Use the [ProfileCompletionFragment.newInstance] factory method to
...
class ProfileCompletionFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ProfileCompletionFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ProfileCompletionFragment().apply {
